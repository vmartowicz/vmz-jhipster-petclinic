...
import fr.vmz.jhipster.petclinic.repository.PetTypeRepository;
import fr.vmz.jhipster.petclinic.service.PetTypeService;
...
/**
 * REST controller for managing {@link fr.vmz.jhipster.petclinic.domain.PetType}.
 */
@RestController
...
public class PetTypeResource {
    ...
    /**
     * {@code GET  /pet-types} : get all the Pet Types.
     *
     * @param pageable the pagination information.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and the list of Pet Types in body.
     */
    @GetMapping("")
