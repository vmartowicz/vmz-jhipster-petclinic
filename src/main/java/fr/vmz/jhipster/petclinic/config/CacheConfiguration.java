...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, fr.vmz.jhipster.petclinic.domain.Specialty.class.getName() + ".vets");
            createCache(cm, fr.vmz.jhipster.petclinic.domain.Vet.class.getName());
            createCache(cm, fr.vmz.jhipster.petclinic.domain.Vet.class.getName() + ".specialties");
            createCache(cm, fr.vmz.jhipster.petclinic.domain.Owner.class.getName());
            createCache(cm, fr.vmz.jhipster.petclinic.domain.Owner.class.getName() + ".pets");
            createCache(cm, fr.vmz.jhipster.petclinic.domain.Pet.class.getName());
            createCache(cm, fr.vmz.jhipster.petclinic.domain.Pet.class.getName() + ".visits");
