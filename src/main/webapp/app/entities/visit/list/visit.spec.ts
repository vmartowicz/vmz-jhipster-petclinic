...
describe('Visit Management Component', () => {
  ...
  describe('trackId', () => {
    it('should forward to visitService', () => {
      ...
      vi.spyOn(service, 'getVisitIdentifier');
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.visitsParams()).toMatchObject({ sort: ['id,desc'] });
  });
  ...
  it('should calculate the filter attribute', () => {
    ...
    // THEN
    expect(service.visitsParams()).toMatchObject({ 'someId.in': ['dc4279ea-cfb9-11ec-9d64-0242ac120002'] });
  });
