...
import { VisitDeleteDialog } from '../delete/visit-delete-dialog';
...
export class Visit implements OnInit {
  ...
  constructor() {
    effect(() => {
      const headers = this.visitService.visitsResource.headers();
      if (headers) {
  ...
  protected fillComponentAttributesFromResponseBody(data: IVisit[]): IVisit[] {
    return data;
  }
  ...
  protected queryBackend(): void {
    ...
    this.visitService.visitsParams.set(queryObject);
  }
